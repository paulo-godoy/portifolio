...
const aboutMeData = {
  ...
  bio: "Sou apaixonado por tecnologia e gosto de criar soluções inovadoras para problemas reais. Além de programar, gosto de viajar com minha esposa e filho e de fazer musculação.",
  imgUrl: "/imagens/perfil.jpeg",
  buttonLabel: "Conheça mais",
  buttonUrl: "https://www.linkedin.com/in/paulo-ricardo-p-godoy-06577333",
};
